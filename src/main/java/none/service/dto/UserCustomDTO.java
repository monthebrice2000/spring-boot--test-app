...
/**
 * A DTO for the {@link none.domain.UserCustom} entity.
 */
...
public class UserCustomDTO implements Serializable {
    ...
    public UserCustomDTO(UserCustom userCustom) {
    ...
    public UserCustomDTO(UserCustomRegister userCustomRegister) {
        //this.id = userCustom.getId();
        this.firstName = userCustomRegister.getFirstName();
        this.lastName = userCustomRegister.getLastName();
        this.username = userCustomRegister.getUsername();
        this.email = userCustomRegister.getEmail();
        this.password = userCustomRegister.getPassword();
        this.role = userCustomRegister.getRole();
        /*this.authorities = userCustomRegister.getAuthorities();
        this.isNotLocked = userCustomRegister.getIsNotLocked();
        this.isActived = userCustom.getIsActived();
        this.joinDate = userCustom.getJoinDate();
        this.lastLoginDate = userCustom.getLastLoginDate();
        this.lastLoginDateDisplay = userCustom.getLastLoginDateDisplay();*/
    ...
    public boolean equals(Object o) {
        ...
        UserCustomDTO userCustom = (UserCustomDTO) o;
        if (this.id == null) {
            return false;
        }
